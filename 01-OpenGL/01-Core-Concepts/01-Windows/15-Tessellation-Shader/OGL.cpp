...
unsigned int uiNumberOfSegments = 1;
...
int initialize(void)
{
    ...
    //! ----------------------------------------------------------------------------
    const GLchar* tesselaationControlShaderSourceCode = 
        "#version 460 core" \
        "\n" \
    ...
    glShaderSource(tessellationControlShaderObject, 1, (const GLchar**)&tesselaationControlShaderSourceCode, NULL);
    ...
    glShaderSource(tessellationEvaluationShaderObject, 1, (const GLchar**)&tessellationEvaluationShaderObject, NULL);
