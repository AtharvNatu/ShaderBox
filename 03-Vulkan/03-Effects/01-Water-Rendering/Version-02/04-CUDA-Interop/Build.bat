...
echo ----------------------------------------------------------------------------------------------------------------
        ...
        @REM %IMGUI_PATH%\imgui.cpp ^
        @REM %IMGUI_PATH%\imgui_draw.cpp ^
        @REM %IMGUI_PATH%\imgui_widgets.cpp ^
        @REM %IMGUI_PATH%\imgui_tables.cpp ^
        @REM %IMGUI_BACKENDS%\imgui_impl_win32.cpp ^
        @REM %IMGUI_BACKENDS%\imgui_impl_vulkan.cpp
