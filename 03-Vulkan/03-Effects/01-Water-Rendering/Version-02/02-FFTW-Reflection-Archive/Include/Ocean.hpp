...
extern VkShaderModule vkShaderModule_vertex_shader, vkShaderModule_fragment_shader, vkShaderModule_compute_shader;
...
extern VkPipeline vkPipeline_compute;
extern VkPipelineLayout vkPipelineLayout_compute;
extern VkDescriptorSetLayout vkDescriptorSetLayout_compute;
extern VkDescriptorSet vkDescriptorSet_compute;
extern VkDescriptorPool vkDescriptorPool_compute;
...
class Ocean
{
    private:
        ...
        VkImage vkImage_texture_sun = VK_NULL_HANDLE;
        VkDeviceMemory vkDeviceMemory_texture_sun = VK_NULL_HANDLE;
        ...
        struct FFTDataOffsets {
            size_t h0;
            size_t h0_conj;
            size_t h_twiddle;
        };
        FFTDataOffsets fftDataSectionOffsets;
        size_t fftDataTotalSize;
        void* fftDataMapped = nullptr;
    ...
    private:
        ...
        VkResult Ocean::createTexture(const char*, VkImage*, VkDeviceMemory*, VkImageView*, VkSampler*);
