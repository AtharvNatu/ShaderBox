...
Ocean::~Ocean()
{
    ...
    if (uniformData_ocean_surface.vkDeviceMemory)
    {
        ...
        fprintf(gpFile, "%s() => vkFreeMemory() Succeeded For uniformData_ocean_surface.vkDeviceMemory\n", __func__);
    }
    ...
    if (uniformData_ocean_surface.vkBuffer)
    {
        ...
        fprintf(gpFile, "%s() => vkDestroyBuffer() Succedded For uniformData_ocean_surface.vkBuffer\n", __func__);
    }
    ...
    if (slopePtr)
    {
        if (cudaFree(slopePtr) == cudaSuccess)
            fprintf(gpFile, "%s() => cudaFree() Succedded For slopePtr\n", __func__);
        slopePtr = nullptr;
    }
    ...
    if (heightPtr)
    {
        if (cudaFree(heightPtr) == cudaSuccess)
            fprintf(gpFile, "%s() => cudaFree() Succedded For heightPtr\n", __func__);
        heightPtr = nullptr;
    }
