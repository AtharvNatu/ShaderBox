...
VkResult createVertexBuffer(void)
{
    ...
    // Code
    __createVertexBuffer(0, triangle_position, triangle_color);
    __createVertexBuffer(1, rectangle_position, rectangle_1_color);
    __createVertexBuffer(2, rectangle_position, rectangle_2_color);
    __createVertexBuffer(3, rectangle_position, rectangle_3_color);
    __createVertexBuffer(4, rectangle_position, rectangle_4_color);
    __createVertexBuffer(5, rectangle_5_position, rectangle_5_color);
    __createVertexBuffer(6, rectangle_position, rectangle_6_color);
...
VkResult buildCommandBuffers(void)
{
    ...
    for (uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        vkCmdBeginRenderPass(vkCommandBuffer_array[i], &vkRenderPassBeginInfo, VK_SUBPASS_CONTENTS_INLINE);
        {
            ...
            //* Building 1
            //* ----------------------------------------------------------------------------------------
            VkCommandBuffer commandBuffer = vkCommandBuffer_array[i];
