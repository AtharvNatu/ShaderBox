...
#ifndef WATER_SURFACE_RENDERING_SCENE_WS_TESSENDORF_HPP
#define WATER_SURFACE_RENDERING_SCENE_WS_TESSENDORF_HPP
...
private:
    ...
    static constexpr float s_kOneOver2sqrt { 0.70710678f };
...
#endif // WATER_SURFACE_RENDERING_SCENE_WS_TESSENDORF_HPP
