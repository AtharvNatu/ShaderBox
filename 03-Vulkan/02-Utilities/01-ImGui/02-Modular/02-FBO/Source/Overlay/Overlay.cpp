...
void Overlay::registerWin32MsgHandler(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    switch(iMsg)
    {
        case WM_MOUSEMOVE:
...
UICategory* Overlay::findCategory(const std::string& name)
{
...
UICategory* Overlay::getCategory(const std::string& name)
{
    UICategory* category = findCategory(name);
    if (!category)
    {
