    ...
    switch(iMsg)
    {
        ...
        case WM_KEYDOWN:
            ...
            switch(wParam)
            {
                ...
                case 53:
                    mesh_size = 1024;
                    currentMeshSize = 1024;
                break;
                
                case 54:
                    mesh_size = 2048;
                    currentMeshSize = 2048;
                break;
...
VkResult createVertexBuffer(void)
{
    ...
    vkBufferCreateInfo.size = MESH_SIZE_2048 * sizeof(float);
...
void renderImGui(void)
{
    ...
    ImGui::PushFont(font);
    {
        ...
        ImGui::Spacing();
        ImGui::Spacing();
        ImGui::TextColored(ImVec4(1.0f, 0.0f, 0.0f, 1.0f), "Mesh Size : %d x %d x 4", currentMeshSize, currentMeshSize);
